...
`<div className="flex flex-col h-[100dvh] w-full bg-gray-100 font-sans items-center justify-center">
      <div className="w-full h-full max-w-md bg-[#FFF8F0] shadow-2xl relative overflow-hidden flex flex-col md:rounded-3xl md:h-[90dvh] md:my-auto md:border-8 md:border-black">`);
